        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CategoryAttributeId1 = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_CategoryAttributeValue", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CategoryAttributeValue_CategoryAttributes_CategoryAttributeId1",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CategoryAttributeValue_CategoryAttributeId1",
